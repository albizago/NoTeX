...
\end{description}
Essi permettono di studiare l'evoluzione di un sistema, determinando gli stati accessibili attraverso processi spontanei, in specifiche condizioni. Per sistemi non isolati, fanno quindi le veci dell'entropia (si tratterà di seguito solo il caso di sistemi chiusi, per cui dunque la quantità di materia complessiva si mantiene costante).
...
\[F = F(T,V,\vec{n}) \quad con \, \vec{n} = (n_1, n_2, ..., n_{CF})\]
